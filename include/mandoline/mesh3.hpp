...
struct CutCellMesh<3> : public CutCellMeshBase<3, CutCellMesh<3>> {
  ...
  public:
    ...
    CutCellMesh(const StaggeredGrid &g, const std::vector<Vertex> &v = {}) : Base(g, v), m_exterior_grid(g) {}
    ...
    std::tuple<mtao::ColVecs3d, mtao::ColVecs3i> compact_triangulated_face(int face_index, bool invert=false) const;
