...
// int nearest_vertex(const CutCellMesh<2>& ccm, Eigen::Ref<const balsa::eigen::Vec2d>
// p); int nearest_edge(const CutCellMesh<2>& ccm, Eigen::Ref<const balsa::eigen::Vec2d>
// p); int nearest_face(const CutCellMesh<2>& ccm, Eigen::Ref<const balsa::eigen::Vec2d>
// p);
//// same as nearest_face
// int nearest_cell(const CutCellMesh<2>& ccm, Eigen::Ref<const balsa::eigen::Vec2d> p)
// {
...
struct BoundaryFacetProjector3 : public mtao::geometry::grid::StaggeredGrid3d {
    ...
    mtao::geometry::grid::GridData3i _cell_ownership_grid;
    mtao::RowVecs3d _V;
    mtao::RowVecs3i _F;
};
...
/// balsa::eigen::Vec3d> p); int nearest_face(const CutCellMesh<3>& ccm,
/// Eigen::Ref<const balsa::eigen::Vec3d> p); int nearest_cell(const CutCellMesh<3>&
/// ccm, Eigen::Ref<const balsa::eigen::Vec3d> p);
///
