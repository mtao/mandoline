...
namespace mandoline::construction {
    CutCellMesh<3> from_grid_unnormalized(const mtao::ColVecs3d& V, const mtao::ColVecs3i& F, const std::array<int,3>& cell_shape, int adaptive_level = 0, std::optional<double> threshold = {});
    ...
    class DeformingGeometryConstructor {
        public:
            DeformingGeometryConstructor(const mtao::ColVecs3d& V, const mtao::ColVecs3i& F, const mtao::geometry::grid::StaggeredGrid3d& grid, int adaptive_level = 0, std::optional<double> threshold = {});
