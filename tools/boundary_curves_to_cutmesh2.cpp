...
int main(int argc, char *argv[]) {
    ...
    options.add_options()("input", "input", cxxopts::value<std::string>())(
      ...
      "Ny", "Grid dimension in y", cxxopts::value<int>()->default_value("5"))("mx", "min value in x", cxxopts::value<double>()->default_value("0"))("my", "min value in y", cxxopts::value<double>()->default_value("0"))("Mx", "max value in x", cxxopts::value<double>()->default_value("10"))("My", "max value in y", cxxopts::value<double>()->default_value("10"))(
      "h,help", "Print usage");
